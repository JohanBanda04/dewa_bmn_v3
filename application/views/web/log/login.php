...
<!--	<div class="container-login100" style="background-color: #a1d5ff">-->
	<div class="container-login100" >
		<div class="wrap-login100" style="padding:20px; background-color: #231018; border-radius: 10px;
		opacity: 88%">
...
<!--					<img style="height: 65px; width: 250px; border-radius: 0px; opacity: 100%" src="img/peresean-title-4.png" alt="IMG"></img>-->
					<img style="height: 95px; width: 250px; border-radius: 0px; opacity: 70%"
                         src="img/dewa_bmn_title.png" alt="IMG"></img>
				</span>

				<span class="login100-form-title" style="color: #8c7e4e;font-size: 17px; padding: 10px 0px 10px 10px;">
					Database Sewa <br> Barang Milik Negara
				</span>
				<?php
