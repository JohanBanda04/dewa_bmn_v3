...
<div id="content" class="content">
    ...
    <h3 class="page-header"  style="font-size: 18px">Selamat Datang di DEWA BMN</h3>
    <!-- end page-header -->
    <!-- begin row -->
    ...
    <div class="row">
        <div class="panel panel-inverse">
            <div class="panel-body">
                ...
                <!--                <hr>-->
                <h5>Lihat Dokumen Sewa BMN Satker</h5>
                <div class="row">

                    <div <?php if ($val->nama_satker=='Superadmin'){ ?>
                        class="col-md-3 hidden"
                    <?php } else if($val->nama_zona=='kasub_perancang') { ?>
                        class="col-md-3 hidden"
                    <?php } else { ?>
                        class="col-md-3"
                    <?php } ?> >
                        <!--                            --><?php //echo "<pre>"; print_r($user->result()); die;?>
                        <a href="sewabmn/sewa/<?= hashids_encrypt(0); ?>" style="text-decoration: none">
                            <div class="widget widget-stats bg-gradient-yellow text-inverse">
                                ...
                                <div class="stats-desc"><?= "Semua Satker";?></div>
...
//                    $dt_tbl_zona = $this->db->get("tbl_zona");
                    ...
                    foreach ($sb_satker->result() as $id=>$val){
                        ?>
                        <div <?php if ($val->nama_satker=='Superadmin'){ ?> class="col-md-3 hidden" <?php }
