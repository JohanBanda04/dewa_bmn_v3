            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <select class="form-control default-select2" name="level"
                              selected="<?php echo $query->level; ?>" required>
                        <option value="">- Pilih Level -</option>
                        <option class="" value="kanwil">Kanwil</option>
                    ...
                    <div class="col-lg-9">
                      <select class="form-control default-select2" name="satker"
                        ...
                        <option value="">- Pilih Satker -</option>
                          <!--trik menghilangkan superadmin-->
                          <?php foreach ($query_satker as $index=>$satker) { ?>
                              <?php if ($satker->nama_satker!='Superadmin'){
                                  ?>
