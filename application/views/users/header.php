...
$sub_menu_not_lowercase = $this->uri->segment(3);

//echo $sub_menu_not_lowercase;die;
...
<head>
	...
	<link rel="shortcut icon" href="assets/dewa_bmn_title.png" type="image/x-icon" />
...
<!--                    <li class="has-sub --><?php //if($menu=='harmonisasi' OR ($menu=='harmonisasi' AND $sub_menu=='v') OR ($menu=='folder_data_dukung' AND $sub_menu=='v') OR ($menu=='data_dukung' AND $sub_menu=='v') OR ($menu=='rpd' AND $sub_menu=='v') OR ($menu=='ankabut' AND $sub_menu=='v')){echo " active";} ?><!--">-->
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php
                                ...
                                foreach ($dt_zona_harmonisasi->result() as $index=>$value){ ?>
                                    <li <?php if($value->nama_zona=='superadmin' or $value->nama_zona=='kasub_perancang'){ ?> hidden <?php } ?>
                            ...
                            <li <?php if(($menu=='harmonisasi' and $sub_menu=='v' and $sub_menu3=='pemprov_ntb') or ($menu=='harmonisasi' and $sub_menu=='v2' and $sub_menu3=='pemprov_ntb')){ echo " class='active'"; } ?>
                                ...
                                <a href="harmonisasi/v/pemprov_ntb.html">
                                    <i class="fa fa-file-text"></i> <span>Pemprov NTB</span>
                                </a>
                            </li>
                    ...
                    <!--menu untuk pemda dihidden dari sini-->
                    <?php
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php
                                ...
                                foreach ($dt_tbl_zona->result() as $id=>$val){ ?>
                                    <li <?php if ($val->nama_zona=="superadmin"){?> hidden <?php } else if($val->nama_zona=="kasub_perancang"){?> hidden <?php } ?>
                    ...
                    <!--menu untuk pemda dihidden sampai sini-->

                    <!--menu untuk data sewa bmn-->
                    <?php
                    $sb_satker = $this->db->get("sb_satker");
                    $id_for_all = 0;
                    ?>
                    <li class="has-sub <?php foreach ($sb_satker->result() as $id=>$val) {
                        if($menu=='sewabmn' AND $sub_menu=='sewa' AND $sub_menu_not_lowercase==hashids_encrypt($val->id)){
                            echo "active";
                        } else if ($menu=='sewabmn' AND $sub_menu=='sewa' AND $sub_menu_not_lowercase==hashids_encrypt($id_for_all)){
                            ?> active <?php
                        }
                    } ?> ">
                        <a href="javascript:;">
                            <b class="caret pull-right"></b>
                            <i class="fa fa-language bg-gray"></i>
                            <span>Data Sewa BMN Satker</span>
                        </a>
                        <!--ini dia sidebar menu-->
                        <ul class="sub-menu">

                            <li <?php if(($menu=='sewabmn' and $sub_menu=='sewa' and $sub_menu_not_lowercase==hashids_encrypt($id_for_all))){ ?> class="active" <?php } ?>
                                <?php if($this->session->userdata('satker_id')==$val->id){?>
                                    class=""
                                <?php } else if ($this->session->userdata('satker_id')=='17') { ?>
                                    class=""
                                <?php } else if($this->session->userdata('satker_id')=='18') { ?>
                                    class=""
                                <?php } else { ?>
                                    class="hidden"
                                <?php } ?>
                            >
                                ...
                                <a href="sewabmn/sewa/<?php echo hashids_encrypt($id_for_all);?>" >
                                    <i class="fa fa-file-text"></i> <span><?= "Semua Satker";?></span>
                                </a>
                            </li>
                            ...
                            foreach ($sb_satker->result() as $id=>$val){ ?>
                                <li <?php if ($val->id=="17"){?> hidden <?php } ?>
                                    <?php if(($menu=='sewabmn' and $sub_menu=='sewa' and $sub_menu_not_lowercase==hashids_encrypt($val->id)) or ($menu=='sewabmn' and $sub_menu=='sewa' and $sub_menu_not_lowercase==hashids_encrypt($val->id))){ echo " class='active'"; } ?>
                                    <?php if($this->session->userdata('satker_id')==$val->id){?>
                                        class=""
                                    <?php } else if ($this->session->userdata('satker_id')=='17') { ?>
                                        class=""
                                    ...
                                    <a href="sewabmn/sewa/<?= hashids_encrypt($val->id); ?>" >
                                        <i class="fa fa-file-text"></i> <span><?= $val->nama_satker;?></span>
                                    </a>
                                </li>
                            <?php }
                            ?>
