...
//	}
	public function get_users()
	{
			return $this->db->get_where($this->sb_user);
	}
...
//	}
	...
	public function get_users_by_un($username)
	{
		return $this->db->get_where($this->sb_user, array('username'=>"$username"));
	}
...
//		$data = "AMERTA - Aplikasi Manajemen Berita";
		$data = "SEWA BMN Kantor Wilayah Kemenkumham NTB";
		return $data;
	}
	...
	{
//		$data = "AMERTA - Aplikasi Manajemen Berita";
		$data = "Aplikasi <span style='color: red'>DEWA BMN</span> Kantor Wilayah Kemenkumham NTB";
		return $data;
	}
	...
	{
		if ($data=='dokumen_lengkap') {
			$v_data = '<label class="label label-success">Dokumen Lengkap</label>';
		}elseif ($data=='dokumen_belum_lengkap') {
			$v_data = '<label class="label label-danger">Dokumen Belum Lengkap</label>';
